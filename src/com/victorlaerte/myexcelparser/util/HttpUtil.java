...
public class HttpUtil {
    ...
    public static JSONObject getJSON(boolean post, String url, Map<String, String> params, Map<String, String> headers, Map<String, String> cookies) throws IOException {

        int statusCode = 0;

        HttpParams httpParams = new BasicHttpParams();

        HttpConnectionParams.setConnectionTimeout(httpParams, 240000);
        ...
        try {
            ...
            throw new UnknownHostException("Código: " + statusCode + " " + getErrorMsg(statusCode)
                    + ". Endereço de IP do host não pode ser determinado.");

        } catch (SocketTimeoutException ex) {

            Logger.getLogger(HttpUtil.class.getName()).log(Level.SEVERE, null, ex);

            throw new SocketTimeoutException("Código: " + statusCode + " " + getErrorMsg(statusCode));

        } catch (SocketException ex) {

            Logger.getLogger(HttpUtil.class.getName()).log(Level.SEVERE, null, ex);

            throw new SocketException("Código: " + statusCode + " " + getErrorMsg(statusCode));
    ...
    public static boolean valid200(int statusCode) {

        return statusCode == 200 || statusCode == 201 || statusCode == 202 || statusCode == 203 || statusCode == 204 || statusCode == 205 || statusCode == 206;
    }

    public static boolean valid300(int statusCode) {

        return statusCode == 300 || statusCode == 301 || statusCode == 302 || statusCode == 303 || statusCode == 304 || statusCode == 305 || statusCode == 307;
    }

    private static HttpPost post(String url, Map<String, String> params, Map<String, String> headers) throws IOException {
        ...
        if (params != null) {
            ...
            postMehod.setEntity(new UrlEncodedFormEntity(nvps, Consts.UTF_8));
        }
